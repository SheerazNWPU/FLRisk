...
class Configuration(object):
    def __init__(self, data_selection, deep_learning_selection):
        ...
        self.data_dict = {
            ...
            16:'CCT',
            17:'hosp_r50',
            12:'/home/15t/Gul/SG/sheeraz/result_archive/risk_elem/Multilabel_FEDSpear_R/',
        }
        self.class_num_dict = {
            0: 196,
            1: 196,
    ...
    def get_parent_path(self, client_name):
        return os.path.join(self.data_path, client_name, 'risk_dataset')
    ...
    def get_decision_tree_rules_path(self, client_name):
        return os.path.join(self.data_path, client_name, 'risk_dataset', 'decision_tree_rules_clean.txt')
    ...
    def get_all_data_path(self, client_name):
        return os.path.join(self.data_path, client_name, 'risk_dataset', 'all_data_info.csv')
