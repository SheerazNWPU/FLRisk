...
2. Open the files **`get_risk_info.py`** and **`get_one_risk_info.py`** and update the paths to the datasets for each client.
...
This code needs to be run for each client separately.
