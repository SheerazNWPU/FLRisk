...
class ratree:
    ...
    def __init__(self, train_data):
        ...
        for eachmetafeature in self.featurenames:
            ...
            # Create an imputer object to fill NaN values with the mean
            imputer = SimpleImputer(strategy='mean')  # Or 'median', 'most_frequent', etc.
            
            # Fit the imputer on the data and transform it
            newX = imputer.fit_transform(newX)
...
def generate_rules():
    ...
    for train_id in train_ids:
        #print(id_2_pair_info.get(train_id))
        #print(id_2_pair_info.get(train_id))
    ...
    read_rules
    #print(match_rule_threshold)
    #print(unmatch_rule_threshold)
...
if __name__ == "__main__":
    ...
    for data_dir in data_dirs:
        for client in clients:
            print('======================================================')
            print('======================================================')
            print('generating rules for {} {}'.format(data_dir, client))
            print('======================================================')
            print('======================================================')
    
            # copy DBLP-Scholar to this project
            # copy DBLP-Scholar to this project
            shutil.rmtree('/home/15t/Gul/SG/cnn/FederatedLearning/RiskModelMultiLabelRiskFederated/ER_tree_2_rules/input_data_2020/DBLP-Scholar')
            shutil.copytree('/home/15t/Gul/SG/sheeraz/result_archive/risk_elem/{}/{}/DBLP-Scholar'.format(data_dir, client),
                            '/home/15t/Gul/SG/cnn/FederatedLearning/RiskModelMultiLabelRiskFederated/ER_tree_2_rules/input_data_2020/DBLP-Scholar')
    
            generate_rules()
     
            #  copy decision_tree_rules_clean.txt to risk dataset
            shutil.copy(
                "/home/15t/Gul/SG/cnn/FederatedLearning/RiskModelMultiLabelRiskFederated/ER_tree_2_rules/input_data_2020/DBLP-Scholar/325/decision_tree_rules_clean.txt",
                "/home/15t/Gul/SG/sheeraz/result_archive/risk_elem/{}/{}/decision_tree_rules_clean.txt".format(data_dir, client),
            )
