...
class DataInfo(object):
    ...
    def update_ground_truth_info(self, id_2_pair_info):
        ...
        np.save('./Results/BRACS/' + self.data_name + '_true_label.npy', self.true_labels)
    ...
    def update_activate_matrix(self, effective_rule_idx, rules):
        ...
        np.save('./Results/BRACS/' + self.data_name + ' rule_activate.npy' , self.rule_activation_matrix)
